# -*- coding: utf-8 -*-
"""EtoE_HousePricePredict.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rHoHM2ymg9ecLP-LO5bFCxuaLqsoD-PU
"""

import pandas as pd

re_df = pd.read_csv('/content/Real_Estate.csv')
re_df.head()
...
fig.suptitle('Histograms of Real Estate Data')
...
for i, col in enumerate(cols):
  sns.histplot(re_df[col], kde=True, ax=axes[i//2, i%2])
...
# Now let's look at the relationship of each variable with house price

fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(10,10))
fig.suptitle('Scatter Plots with House Price of Unit Area')

sns.scatterplot(data=re_df, x='House age', y='House price of unit area', ax=axes[0,0])
sns.scatterplot(data=re_df, x='Distance to the nearest MRT station', y='House price of unit area', ax=axes[0,1])
sns.scatterplot(data=re_df, x='Number of convenience stores', y='House price of unit area', ax=axes[1,0])
sns.scatterplot(data=re_df, x='Latitude', y='House price of unit area', ax=axes[1,1])
...
# Performing a correlation analysis to quantify the relationships between these variables,
# especially how each one correlates with the house price

corr_matrix = re_df.corr()
...
* Many points are close to the diagonal line, suggesting that the model
makes reasonably accurate predictions for a significant portion of the test set.
